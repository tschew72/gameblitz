      ...
      <main className="min-h-screen flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md phase-enter">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => onComplete(score, factsLearned)} className="flex-1 py-4 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl font-bold transition-all hover:scale-105">
              Complete
            </button>
          </div>
        </div>
    ...
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 p-4 z-30">
        <div className="max-w-lg mx-auto flex justify-between items-center">
          ...
          <span className="text-white/60">{Math.floor(distance)}m</span>
        </div>
        {/* Progress bar */}
