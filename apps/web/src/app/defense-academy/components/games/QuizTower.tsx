  ...
  if (phase === 'countdown') {
    return (
      <main className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div
          key={countdownNum}
          className="relative z-10 text-[100px] sm:text-[150px] md:text-[200px] font-black bg-gradient-to-b from-amber-400 to-orange-400 bg-clip-text text-transparent animate-countdown"
        >
          {countdownNum || 'DEFEND!'}
        </div>
      </main>
      ...
      <main className="min-h-screen flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md phase-enter">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => { onComplete(score, factsLearned); onBack(); }} className="flex-1 py-4 bg-gradient-to-r from-amber-500 to-orange-500 rounded-xl font-bold transition-all hover:scale-105">
              Complete
            </button>
          </div>
        </div>
    ...
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 p-3 z-30 bg-gradient-to-b from-black/50 to-transparent">
        ...
        <div className="max-w-lg mx-auto mt-2 flex justify-between items-center text-sm">
          <span className="text-white/60">Wave {waveNum}/{maxWaves}</span>
