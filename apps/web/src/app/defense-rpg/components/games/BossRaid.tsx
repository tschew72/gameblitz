  ...
  if (phase === 'countdown') {
    return (
      <main className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div
          key={countdownNum}
          className="relative z-10 text-[100px] sm:text-[150px] md:text-[200px] font-black bg-gradient-to-b from-red-400 via-orange-400 to-amber-400 bg-clip-text text-transparent animate-countdown"
        >
          {countdownNum || 'FIGHT!'}
        </div>
      </main>
      ...
      <main className="min-h-screen flex flex-col items-center justify-center p-4 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md phase-enter">
          ...
          <div className="flex gap-3">
            ...
            <button onClick={() => { onComplete(score, factsLearned, expEarned); onBack(); }} className="flex-1 py-4 bg-gradient-to-r from-red-500 to-amber-500 rounded-xl font-bold transition-all hover:scale-105">
              Complete
            </button>
          </div>
        </div>
  ...
  return (
    <main className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-lg mx-auto p-4 h-screen flex flex-col">
        {/* HUD */}
        <div className="flex justify-between items-center py-4 px-3 bg-gradient-to-r from-white/5 to-transparent rounded-xl">
          <button
